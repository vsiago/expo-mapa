  ...
  return (
    <div style={{ position: 'relative', height: '100vh', width: '100vw' }}>
      ...
      >
        ...
        <PinParque latitude={'-26.000'} longitude={'55.000'} /> // Praca de alimentacao
        <PinParque latitude={'-15.000'} longitude={'136.000'} /> // Arena Game
        <PinParque latitude={'-39.000'} longitude={'170.000'} /> // Arena Educacao
        ...
        <PinPalcoLaia latitude={'6.000'} longitude={'-89.000'} /> // Maria Bonita
      </MapContainer>
    </div>
  );
};
