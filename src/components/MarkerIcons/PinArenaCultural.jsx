...
import pinPalcoLaiaIcon from '/img/ArenaCultural/cultural-icon.png';
import './pinpalcolaia.css';
import './pinarenacultural.css';
import PalcoLaia from '../../ModelProgramacaoExpo/ArenaEducacao';

const PinArenaCultural = ({ latitude, longitude }) => {
  useEffect(() => {
...
export default PinArenaCultural;
